...
export default function EditarPropiedad4({ route, navigation }) {
    ...
    const {selectedImages, propertyID, propiedad, calle, numero, piso, departamento, localidad, ciudad, provincia, pais, latitud, longitud, tipoPropiedad, m2cub, m2semi, m2desc, antiguedad, ambientes, habitaciones, banos } = route.params;
    ...
    const handleSubmit = async () => {
        if (ubicacion === '' || orientacion === '') {
            ...
            navigation.navigate('Editar propiedad: Paso 5', {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.form1}>
                ...
                <View style={styles.fila}>
                    ...
                    <TextInput
                        style={styles.input}
                        placeholder={propiedad.propiedad.propiedad.garage}
                        value={garage}
            ...
            <View style={styles.form2}>
                ...
                <Dropdown
                    ...
                    placeholder={propiedad.propiedad.propiedad.frontOrBack}
                ...
                <Dropdown
                    style={styles.dropdown}
                    placeholder={propiedad.propiedad.propiedad.orientation}
                    selectedTextStyle={styles.selectedTextStyle}
                    inputSearchStyle={styles.inputSearchStyle}
                    iconStyle={styles.iconStyle}
                ...
                <MultiSelect
                    style={styles.dropdown}
                    placeholder={propiedad.propiedad.propiedad.amenities}
                    iconStyle={styles.iconStyle}
                    data={dataAmenities}
                    labelField="label"
                    valueField="value"
